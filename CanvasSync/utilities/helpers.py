...
def validate_domain(domain):
    ...
    try:
        ...
        if (response == u"{\"status\":\"unauthenticated\",\"errors\":[{\"message\":\"user authorization required\"}]}" or
            response == u"{\"status\":\"no autenticado\",\"errors\":[{\"message\":\"Autorización del Usuario Requerida\"}]}"):
